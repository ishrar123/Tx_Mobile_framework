...
public class ExcelDataUtil {
    ...
    private static final String testDatafilePath1 = ConfigReader.getValue("testDataExcelPath1");
     ...
     * @return test data with test case id
     */
    public static HashMap<String, String> getTestDataWithTestCaseID(String fileName, String sheetName, String testCaseID) {
        boolean found = false;
        boolean isfirstRow = false;
        Row firstrow = null;
        DataFormatter fm = new DataFormatter();
        ...
        switch (fileName.toLowerCase()) {
            case "nitrox":
                fileNamePath = testDatafilePathNitroX;
                break;
            case "xalpha":
    ...
    public static CommonSettings getCommonSettings() {
        ...
        try (FileInputStream fis = new FileInputStream(
                System.getProperty("user.dir") + ConfigReader.getValue(automationcontrolexcelpath));
            ...
            commonSettings.setTestlinkOrgName(val);

            val = sheet.getRow(27).getCell(1).getStringCellValue();
            commonSettings.setTestLinkSuiteId(val);
            ...
            val = sheet.getRow(38).getCell(1).getStringCellValue();
            commonSettings.setRestAccessToken(val);

            Double val1 = sheet.getRow(41).getCell(1).getNumericCellValue();
            commonSettings.setAndroidVersion(val1);

            val = sheet.getRow(42).getCell(1).getStringCellValue();
